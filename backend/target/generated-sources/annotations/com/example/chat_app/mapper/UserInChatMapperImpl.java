...
@Generated(
    ...
    date = "2025-04-21T12:43:43+0400",
    comments = "version: 1.5.5.Final, compiler: Eclipse JDT (IDE) 3.42.0.z20250331-1358, environment: Java 21.0.6 (Eclipse Adoptium)"
)
@Component
public class UserInChatMapperImpl implements UserInChatMapper {

    @Override
    public UserInChatDTO toDto(UserInChat userInChat) {
        if ( userInChat == null ) {
            return null;
        }

        UserInChatDTO userInChatDTO = new UserInChatDTO();

        userInChatDTO.setId( userInChat.getId() );

        return userInChatDTO;
    }

    @Override
    public UserInChat toEntity(UserInChatDTO userInChatDTO) {
        ...
        userInChat.setUser( userDTOToUser( userInChatDTO.getUser() ) );
    ...
    protected List<UserInChat> userInChatDTOListToUserInChatList(List<UserInChatDTO> list) {
        ...
        for ( UserInChatDTO userInChatDTO : list ) {
            list1.add( toEntity( userInChatDTO ) );
        }
